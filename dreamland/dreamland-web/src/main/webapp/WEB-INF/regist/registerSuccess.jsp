...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">Dreamland - 杰の博客注册成功页面</span>
    </div>
    <div class="content">
    ...
    <div class="foot" style="position: absolute;left: 280px;float: left;">
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 200px">
                ...
                <p style="margin-top: 8px">&copy;www.dreamland.wang 杰の博客版权所有</p>
            </div>
        </div>
...
<script language=javascript>
    ...
    function lookEmail(message) {
        /*参数 message 是邮箱和激活码通过 , 号拼接的字符串，根据 , 号切割取出邮箱。*/
        var arr = message.split(",");
        var email = arr[0];
        /*根据 @ 切割取出邮箱 @ 后面部分，主要根据 @ 后面的信息进行跳转。*/
        var opt = email.split("@")[1];
        /*如果后面部分是 qq.com 则链接到 QQ 邮箱，其他同理。*/
        if("qq.com"==opt){
    ...
    function reRegist() {
        location.href = "${ctx}/register.jsp";
    }
</script>
</html>