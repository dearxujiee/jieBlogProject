            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="account-login">
                    <form id="normal_form" name="form" role="form" class="login-form" action="${ctx}/doLogin" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="email" name="email" onblur="checkEmail();" value="${email}" class="form-control" placeholder="邮箱">
                            <br/>
                        ...
                        <div class="form-group">
                            ...
                            <br/>
                            <span id="password_erro" style="color: red"></span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    <c:if test="${error eq 'fail'}">
                                        <span style="color: red" id="back_data">邮箱或者密码错误</span>
                                    </c:if>
                ...
                <div class="tab-pane fade" id="phone-login">
                    <form role="form" class="login-form form-horizontal" id="phone_form" action="${ctx}/doLogin" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <button type="button" id="phone_btn" class="btn btn-primary btn-block" onclick="normal_login()">登录</button>
                                <br/>
                                <div style="margin-left: 260px"> <a href = "register.jsp" >立即注册</a></div>
                            </div>
                        </div>
...
<script>
    ...
    function checkEmail() {
        ...
        if(email == ""){
            $("#normal_span").text("请输入邮箱或密码！").css("color","red");
            return false;
        }else{
    ...
    function normal_login() {
        if(checkEmail() && checkPassword() && checkCode()) {
            $("#normal_form").submit();
        }
    }
