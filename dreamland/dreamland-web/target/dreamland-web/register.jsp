...
<head>
	<meta charset="UTF-8">
	<title>杰の博客-注册页面</title>
	<meta name="keywords" content="杰の博客">
	<meta name="content" content="杰の博客">
    ...
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《杰の博客用户协议》</span></a></span>
                    <br/>
                    <span id="protocol_span"></span>
                </div>
                <input name="注册" type="button" class="btn_zhuce" onclick="submitRegister()" id ="to_register" value="注册">
                  <br/>
...
<script type="text/javascript">
    ...
    function submitRegister(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受杰の博客用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
